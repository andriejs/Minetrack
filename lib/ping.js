const minecraftJavaPing = await import('mcping-js');
const minecraftBedrockPing = await import('mcpe-ping-fixed');

const logger = await import('./logger');
const MessageOf = await import('./message');
const { TimeTracker } = await import('./time');

const { getPlayerCountOrNull } = await import('./util');
