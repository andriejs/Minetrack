...
const DNSResolver = await import('./dns.js');
const Server = await import('./server.js');

const { GRAPH_UPDATE_TIME_GAP, TimeTracker } = await import('./time.js');
const { getPlayerCountOrNull } = await import('./util.js');

const config = await import('../config');
const minecraftVersions = await import('../minecraft_versions');
